// Taken from
// <https://github.com/inconshreveable/go-update/tree/3f0466666779bd2143f368a207b0641f0ed536e8>
// before its API changed to something no longer usable for my purposes.
//
